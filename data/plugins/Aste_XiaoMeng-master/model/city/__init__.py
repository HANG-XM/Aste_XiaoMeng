from .city_sign import xm_main, check_in, query, bind
...
from .city_game import update_notice,game_menu,special_code,history_event

# 统一导出
__all__ = [
    "xm_main", "check_in", "query", "bind",
    ...
    "update_notice","game_menu","special_code","history_event",
]